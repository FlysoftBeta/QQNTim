...
module.exports = (qqntim) => {
    ...
    qqntim.nt.getFriendsList().then((list) => {
        ...
        list.forEach((friend) => qqntim.nt.getPreviousMessages({ chatType: "friend", uid: friend.uid }, 20).then((messages) => console.log(`[Example-NT-API] 好友 ${friend.nickName} (${friend.uid}) 的最近 20 条消息`, messages)));
    });
